...
const cases: [string, React.ComponentType<React.ComponentProps<typeof HorizonteSerenoLayout>>][] = [
  ['HorizonteSerenoLayout', HorizonteSerenoLayout],
  ['NoiteEstreladaLayout', NoiteEstreladaLayout],
  ['MemoriaVivaLayout', MemoriaVivaLayout],
];

describe('ProLayoutsB', () => {
