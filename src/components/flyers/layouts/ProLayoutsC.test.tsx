...
const cases: [string, React.ComponentType<React.ComponentProps<typeof AnjoGuardiaoLayout>>][] = [
  ['AnjoGuardiaoLayout', AnjoGuardiaoLayout],
  ['FolhasOutonoLayout', FolhasOutonoLayout],
  ['CristalAzulLayout', CristalAzulLayout],
];

describe('ProLayoutsC', () => {
