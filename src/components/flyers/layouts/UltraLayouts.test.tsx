...
const cases: [string, React.ComponentType<React.ComponentProps<typeof Profundidade3DLayout>>][] = [
  ['Profundidade3DLayout', Profundidade3DLayout],
  ['AquarelaUltraLayout', AquarelaUltraLayout],
  ['VideoUltraLayout', VideoUltraLayout],
];

describe('UltraLayouts', () => {
