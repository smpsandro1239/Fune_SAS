...
const cases: [string, React.ComponentType<React.ComponentProps<typeof CruzDouradaLayout>>][] = [
  ['CruzDouradaLayout', CruzDouradaLayout],
  ['RosaEternaLayout', RosaEternaLayout],
  ['PombaPazLayout', PombaPazLayout],
];

describe('ProLayoutsA', () => {
