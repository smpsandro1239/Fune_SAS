...
const cases: [string, React.ComponentType<React.ComponentProps<typeof DouradoPremiumLayout>>][] = [
  ['DouradoPremiumLayout', DouradoPremiumLayout],
  ['MarmorePremiumLayout', MarmorePremiumLayout],
  ['LuzRadianteLayout', LuzRadianteLayout],
  ['JardimPremiumLayout', JardimPremiumLayout],
  ['VelasPremiumLayout', VelasPremiumLayout],
];

describe('PremiumLayouts', () => {
