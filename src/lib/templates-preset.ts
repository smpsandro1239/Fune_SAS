...
export const PRESET_TEMPLATES: FlyerTemplateConfig[] = [
  ...
  /* ============================== NOVOS PROFISSIONAIS II ============================== */
  {
    id: 'memorial-campo-template',
    name: 'Memória no Campo',
    plan: 'FREE',
    category: 'MISSA_7DIA',
    description: 'Ambiente pastoral e sereno para convite de missa de 7º dia, com colinas suaves e moldura delicada.',
    primaryColor: '#3f4a36',
    secondaryColor: '#f6f4ee',
    accentColor: '#7d9b76',
    fontFamily: 'serif',
    layoutStyle: 'memorial-campo',
  },
  {
    id: 'gratidao-luz-template',
    name: 'Gratidão e Luz',
    plan: 'FREE',
    category: 'AGRADECIMENTO',
    description: 'Cartão de agradecimento caloroso por presença e condolências, em tons ambarados e elegante.',
    primaryColor: '#5b4632',
    secondaryColor: '#fffdf5',
    accentColor: '#c9a227',
    fontFamily: 'serif',
    layoutStyle: 'gratidao-luz',
  },
  {
    id: 'velada-orquidea-template',
    name: 'Velada Orquídea',
    plan: 'PREMIUM',
    category: 'PARTICIPACAO',
    description: 'Orquídeas delicadas a emoldurar o retrato, em estilo premium luxuoso para a despedida.',
    primaryColor: '#4a2c3a',
    secondaryColor: '#faf6f2',
    accentColor: '#b06a8a',
    fontFamily: 'serif',
    layoutStyle: 'velada-orquidea',
  },
  {
    id: 'missa-setimo-dia-template',
    name: 'Missa de 7º Dia',
    plan: 'PREMIUM',
    category: 'MISSA_7DIA',
    description: 'Convite solene de missa de 7º dia com vela acesa, retrato circular e fundo azul-noite.',
    primaryColor: '#1c2638',
    secondaryColor: '#0f1626',
    accentColor: '#d4af37',
    fontFamily: 'serif',
    layoutStyle: 'missa-setimo-dia',
  },
  {
    id: 'ceu-eterno-template',
    name: 'Céu Eterno',
    plan: 'ULTRA',
    category: 'PARTICIPACAO',
    description: 'Céu estrelado animado com brilho dourado e título em degradê luminoso. Elegância suprema para a despedida.',
    primaryColor: '#04070f',
    secondaryColor: '#0a1224',
    accentColor: '#d4af37',
    fontFamily: 'display',
    layoutStyle: 'ceu-eterno',
    animated: true,
  },
